/*
   This is an alternative for the old writeData that was made by HackJack &
   Razzile
*/
...
/*
 * expects file name and relative offset, you can pass NULL as filename for base
 * executable
 */
static inline bool writeData8(const char *fileName, uintptr_t offset,
                              uint8_t data) {
 ...
 * executable
 */
static inline bool writeData16(const char *fileName, uintptr_t offset,
                               uint16_t data) {
 ...
 * executable
 */
static inline bool writeData32(const char *fileName, uintptr_t offset,
                               uint32_t data) {
 ...
 * executable
 */
static inline bool writeData64(const char *fileName, uintptr_t offset,
                               uint64_t data) {
